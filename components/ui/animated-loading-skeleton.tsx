...
const AnimatedLoadingSkeleton = () => {
  ...
  return (
    <motion.div
      className="w-full max-w-4xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg"
      variants={frameVariants}
      initial="hidden"
      animate="visible"
    >
      <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[...Array(config.numCards)].map((_, i) => (
            ...
            >
              {/* Card placeholders */}
              <motion.div
                className="h-32 bg-gray-200 dark:bg-gray-600 rounded-md mb-3"
                animate={{
              ...
              />
              <motion.div
                className="h-3 w-3/4 bg-gray-200 dark:bg-gray-600 rounded mb-2"
                animate={{
                  background: ["#f3f4f6", "#e5e7eb", "#f3f4f6"],
                }}
                transition={{ duration: 1.5, repeat: Number.POSITIVE_INFINITY }}
              />
              <motion.div
                className="h-3 w-1/2 bg-gray-200 dark:bg-gray-600 rounded"
                animate={{
                  background: ["#f3f4f6", "#e5e7eb", "#f3f4f6"],
                }}
                transition={{ duration: 1.5, repeat: Number.POSITIVE_INFINITY }}
